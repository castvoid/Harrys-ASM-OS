; bootloader.asm  FAT12 bootstrap for real mode image or loader
...
brLabel         DB      "Harry's OS",0   ; 002Bh - Volume label
...
errmsg  db  10,"Error loading Harry's ASM OS",13
...
filename db "HASMOS  BIN"       ;11 byte name
